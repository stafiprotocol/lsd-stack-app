...
export const SetPointSystemReadyModal = ({
  open,
  close,
  tutorialUrl,
}: Props) => {
    ...
    <Modal open={open} onClose={close}>
      ...
      >
        ...
        <div className="text-[.24rem] leading-[.28rem] font-[700] mt-[.16rem] text-center">
          Point System Is Ready
          <br /> Now!
        </div>

        <div className="mt-[.16rem] text-[.16rem] leading-[.24rem] text-text2 w-[2.78rem] mx-auto text-center">
          Now you can <span className="text-text1">run your relay service</span>{' '}
          and <span className="text-text1">deploy your own LSD</span> app,
          Congratulations!
        </div>
