...
export const modularConfigs = {
  ...
  supportList: {
    ...
    [AppEco.Cosmos]: [ModuleType.Ai, ModuleType.Frontend, ModuleType.Ccip],
    [AppEco.Sol]: [ModuleType.Frontend],
    [AppEco.Polkadot]: [ModuleType.Frontend, ModuleType.Ccip],
    [AppEco.Others]: [ModuleType.Frontend, ModuleType.Ccip],
  },
};
